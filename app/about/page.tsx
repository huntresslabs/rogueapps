  ...
  return (
    <div className={styles.container}>
      <main className={styles.main}>
        ...
        <p>This project aims to surface OIDC/OAuth 2.0 application tradecraft to aid defenders in identity detection, deterrence, and mitigation of application attacks in the SaaS world.</p>
